        ...
        extends GeneralDigest
{
     ...
     * message digest.
     */
    public SM3NewDigest(SM3NewDigest t)
    {
        super(t);
    ...
    private void copyIn(SM3NewDigest t)
    {
    ...
    {
        return new SM3NewDigest(this);
    }

    public void reset(Memoable other)
    {
        SM3NewDigest d = (SM3NewDigest)other;
